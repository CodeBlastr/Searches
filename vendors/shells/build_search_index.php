...
protected function _setAvailableModels() {
	...
	$this->_availableModelnames = $settings['model'];
	foreach($settings['model'] as $model) {
		ClassRegistry::init($model)->Behaviors->attach('Searchable.Searchable');
	}
...
public function help() {
	...
	$this->out("\nall\n\tBuilds search index for all searchable modelse.g. cake build_search_index all");
